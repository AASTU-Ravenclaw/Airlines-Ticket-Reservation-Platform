    ...
    <div className="max-w-4xl mx-auto py-8">
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Flight {flight.flight_number}</h1>
        ...
        {!isBooking ? (
          <div className="text-center">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-300 text-lg"
            >
              Book This Flight
            </button>
          </div>
